...
tbcs_6mo <- fread ("v1.4.2/TBCS_6m_simulated.csv" , colClasses = list(character = "TOWN")) #use fread() or read_csv they're faster
tbcs_18mo <- fread("v1.4.2/TBCS_18m_simulated.csv")
